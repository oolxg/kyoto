...
public class AccessValidatorTests
{
    ...
    [Fact]
    public async Task
        ValidateRequestAsync_WhenIpIsNotBannedAndNoTokenGiven_ReturnsValidationResultWithBlockFalse_ShouldNotBanTokenOrIp()
    {
        // Arrange
    ...
    [Fact]
    public async Task
        ValidateRequestAsync_WhenIpAndTokenAreNotBanned_GivenIpAndToken_ReturnsValidationResultWithBlockFalse()
    {
        // Arrange
        var tokenInfo = new TokenInfo("Test token");
        _tokenRepositoryFake.Tokens.Add(tokenInfo);
    ...
    [Fact]
    public async Task
        ValidateRequestAsync_WhenTokenIsWhitelisted_GivenWhitelistedToken_ReturnsValidationResultWithBlockFalse()
    {
        // Arrange
        var tokenInfo = new TokenInfo("Test token");
    ...
    [Fact]
    public async Task
        ValidateRequestAsync_WhenIpAndTokenAreWhitelisted_GivenWhitelistedIpAndToken_ReturnsValidationResultWithBlockFalse()
    {
        // Arrange
        var tokenInfo = new TokenInfo("Test token");
        tokenInfo.UpdateStatus(TokenStatus.Whitelisted, "Test reason");
    ...
    [Fact]
    public async Task
        ValidateRequestAsync_WhenUrlIsBlockedWithNoTimeLimit_NoTokenGiven_ReturnsValidationResultWithBlockTrue()
    {
        // Arrange
        var userRequestInfo = CreateRequestInfo(headers: _defaultHeaders);
        var ipInfo = new IpAddressInfo(userRequestInfo.UserIp);
        var userRequest = userRequestInfo.AsUserRequest(ipInfo.Id, null);
        userRequest.IpInfo = ipInfo;
        _restrictedUrlRepositoryFake.RestrictedUrls.Add(new RestrictedUrl(userRequestInfo.Host, userRequestInfo.Path,
            "Test reason"));
    ...
    [Fact]
    public async Task
        ValidateRequestAsync_WhenUrlIsBlockedWithNoTimeLimit_TokenGiven_ReturnsValidationResultWithBlockTrue()
    {
        // Arrange
        var tokenInfo = new TokenInfo("Test token");
        _tokenRepositoryFake.Tokens.Add(tokenInfo);
    ...
    [Fact]
    public async Task
        ValidateRequestAsync_WhenUrlIsBlockedWithNoTimeLimit_GivenWhitelistedIpAndToken_ReturnsValidationResultWithBlockFalse()
    {
        // Arrange
        var tokenInfo = new TokenInfo("Test token");
        tokenInfo.UpdateStatus(TokenStatus.Whitelisted, "Test reason");
    ...
    [Fact]
    public async Task
        ValidateRequestAsync_WhenUrlIsBlockedWithNoTimeLimit_GivenWhitelistedIpAndNoToken_ReturnsValidationResultWithBlockFalse()
    {
        // Arrange
        var userRequestInfo = CreateRequestInfo(headers: _defaultHeaders);
        var ipInfo = new IpAddressInfo(userRequestInfo.UserIp);
    ...
    [Fact]
    public async Task
        ValidateRequestAsync_WhenUrlIsBlockedWithNoTimeLimit_GivenWhitelistedTokenAndIp_ReturnsValidationResultWithBlockFalse()
    {
        // Arrange
        var tokenInfo = new TokenInfo("Test token");
        tokenInfo.UpdateStatus(TokenStatus.Whitelisted, "Test reason");
    ...
    [Fact]
    public async Task
        ValidateRequestAsync_WhenUrlIsBlockedWithTimeLimit_GivenNoTokenAndDateIsNotPassed_ReturnsValidationResultWithBlockTrue()
    {
        // Arrange
        var userRequestInfo = CreateRequestInfo(headers: _defaultHeaders);
        var ipInfo = new IpAddressInfo(userRequestInfo.UserIp);
        var userRequest = userRequestInfo.AsUserRequest(ipInfo.Id, null);
        userRequest.IpInfo = ipInfo;
        var restrictedUrl = new RestrictedUrl(userRequestInfo.Host, userRequestInfo.Path, "Test reason",
    ...
    [Fact]
    public async Task
        ValidateRequestAsync_WhenUrlIsBlockedWithTimeLimit_GivenTokenAndDateNotIsPassed_ReturnsValidationResultWithBlockTrue()
    {
        // Arrange
        var tokenInfo = new TokenInfo("Test token");
        _tokenRepositoryFake.Tokens.Add(tokenInfo);
    ...
    [Fact]
    public async Task
        ValidateRequestAsync_WhenUrlIsBlockedWithTimeLimit_GivenNoTokenAndDateIsPassed_ReturnsValidationResultWithBlockFalse()
    {
        // Arrange
        var userRequestInfo = CreateRequestInfo(headers: _defaultHeaders);
        var ipInfo = new IpAddressInfo(userRequestInfo.UserIp);
    ...
    [Fact]
    public async Task
        ValidateRequestAsync_WhenUrlIsBlockedWithTimeLimit_GivenTokenAndDateIsPassed_ReturnsValidationResultWithBlockFalse()
    {
        // Arrange
        var tokenInfo = new TokenInfo("Test token");
        _tokenRepositoryFake.Tokens.Add(tokenInfo);
    ...
    [Fact]
    public async Task
        ValidateRequestAsync_WhenUrlIsBlockedWithTimeLimit_GivenWhitelistedIpAndTokenAndDateIsNotPassed_ReturnsValidationResultWithBlockFalse()
    {
        // Arrange
        var tokenInfo = new TokenInfo("Test token");
        tokenInfo.UpdateStatus(TokenStatus.Whitelisted, "Test reason");
    ...
    [Fact]
    public async Task
        ValidateRequestAsync_WhenUrlIsBlockedWithTimeLimit_GivenWhitelistedIpAndTokenAndDateIsPassed_ReturnsValidationResultWithBlockFalse()
    {
        // Arrange
        var tokenInfo = new TokenInfo("Test token");
        tokenInfo.UpdateStatus(TokenStatus.Whitelisted, "Test reason");
    ...
    [Fact]
    public async Task
        ValidateRequestAsync_WhenUrlIsBlockedWithTimeLimit_GivenWhitelistedTokenAndIpAndDateIsNotPassed_ReturnsValidationResultWithBlockFalse()
    {
        // Arrange
        var tokenInfo = new TokenInfo("Test token");
        tokenInfo.UpdateStatus(TokenStatus.Whitelisted, "Test reason");
    ...
    [Fact]
    public async Task
        ValidateRequestAsync_WhenUrlIsBlockedWithTimeLimit_GivenWhitelistedTokenAndIpAndDateIsPassed_ReturnsValidationResultWithBlockFalse()
    {
        // Arrange
        var tokenInfo = new TokenInfo("Test token");
        tokenInfo.UpdateStatus(TokenStatus.Whitelisted, "Test reason");
    ...
    [Fact]
    public async Task
        ValidateRequestAsync_WhenRequestIsFromCrawler_GivenBlockedUrlWithNoTimeLimit_ReturnsValidationResultWithBlockFalse()
    {
        // Arrange
        _defaultHeaders["User-Agent"] = "Mozilla/5.0 (compatible; YandexBot/3.0; +http://yandex.com/bots)";
        var userRequestInfo = CreateRequestInfo(headers: _defaultHeaders);
    ...
    [Fact]
    public async Task
        ValidateRequestAsync_WhenRequestIsFromCrawler_GivenBlockedUrlWithTimeLimitAndDateIsNotPassed_ReturnsValidationResultWithBlockFalse()
    {
        // Arrange
        _defaultHeaders["User-Agent"] = "Mozilla/5.0 (compatible; YandexBot/3.0; +http://yandex.com/bots)";
        var userRequestInfo = CreateRequestInfo(headers: _defaultHeaders);
    ...
    [Fact]
    public async Task
        ValidateRequestAsync_WhenRequestIsFromCrawler_GivenBlockedUrlWithTimeLimitAndDateIsPassed_ReturnsValidationResultWithBlockFalse()
    {
        // Arrange
        _defaultHeaders["User-Agent"] = "Mozilla/5.0 (compatible; YandexBot/3.0; +http://yandex.com/bots)";
        var userRequestInfo = CreateRequestInfo(headers: _defaultHeaders);
    ...
    [Fact]
    public async Task
        ValidateRequestAsync_GivenRecentBlockedRequestToPageAndLessThan5MinutesIntervalAndNoReferer_ReturnsValidationResultWithBlockTrue()
    {
        // Arrange
        var bannedUserRequestInfo = CreateRequestInfo(DateTime.UtcNow.AddMinutes(-4));
    ...
    [Fact]
    public async Task
        ValidateRequestAsync_GivenRecentBlockedRequestToPageAndMoreThan5MinutesIntervalAndValidReferer_ReturnsValidationResultWithBlockFalse()
    {
        // Arrange
        var bannedUserRequestInfo = CreateRequestInfo(DateTime.UtcNow.AddMinutes(-7), headers: _defaultHeaders);
        var bannedUserRequest = bannedUserRequestInfo.AsUserRequest(Guid.Empty, null);
        bannedUserRequest.IsBlocked = true;
        _userRequestRepositoryFake.UserRequests.Add(bannedUserRequest);
    ...
    [Fact]
    public async Task
        ValidateRequestAsync_GivenRecentBlockedRequestToPageAndMoreThan5MinutesIntervalAndNoReferer_ReturnsValidationResultWithBlockTrue()
    {
        // Arrange
        var bannedUserRequestInfo = CreateRequestInfo(DateTime.UtcNow.AddMinutes(-7), headers: _defaultHeaders);
        var bannedUserRequest = bannedUserRequestInfo.AsUserRequest(Guid.Empty, null);
    ...
    [Fact]
    public async Task
        ValidateRequestAsync_GivenRecentBlockedRequestToPageAndMoreThan30MinutesIntervalAndNoReferer_ReturnsValidationResultWithBlockFalse()
    {
        // Arrange
        var bannedUserRequestInfo = CreateRequestInfo(DateTime.UtcNow.AddMinutes(-31), headers: _defaultHeaders);
        var bannedUserRequest = bannedUserRequestInfo.AsUserRequest(Guid.Empty, null);
        bannedUserRequest.IsBlocked = true;
        _userRequestRepositoryFake.UserRequests.Add(bannedUserRequest);
    ...
    [Fact]
    public async Task
        ValidateRequestAsync_GivenRecentBlockedRequestToPageAndMoreThan30MinutesIntervalAndValidReferer_ReturnsValidationResultWithBlockFalse()
    {
        // Arrange
        var bannedUserRequestInfo = CreateRequestInfo(DateTime.UtcNow.AddMinutes(-31), headers: _defaultHeaders);
        var bannedUserRequest = bannedUserRequestInfo.AsUserRequest(Guid.Empty, null);
